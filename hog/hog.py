    ...
    while True:
        if score0 < goal and score1 < goal:
            if who == 0:
                ...
                score0 = score0 + take_turn(num, score1, dice, goal)
                score0, score1 = hog_pile(score0, score1)
            elif who == 1:
                num = strategy1(score0, score1)
                score1 = score1 + take_turn(num, score0, dice, goal)
                score1, score0 = hog_pile(score1, score0)
        else:
            break
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_dice = make_averaged(roll_dice)
    max_result = 0
    max_i = 0
    for i in range(1,11):
        max_result_maybe = max_dice(i,dice)
        if max_result < max_result_maybe:
            max_result = max_result_maybe
            max_i = i
    return max_i
    # END PROBLEM 9
